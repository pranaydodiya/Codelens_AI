// Static dummy data for CodeLens UI
...
export const PULL_REQUESTS: Array<{
  id: string;
  title: string;
  author: string;
  authorAvatar: string;
...
export const SAMPLE_CODE = `import { createContext, useContext, useState, useEffect } from 'react';
...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const logout = () => {
    ...
    // WARNING: This console.log exposes token data
    console.log('User logged out:', AuthStorage.getToken());
    setState({ isAuthenticated: false, user: null, loading: false });
  };
